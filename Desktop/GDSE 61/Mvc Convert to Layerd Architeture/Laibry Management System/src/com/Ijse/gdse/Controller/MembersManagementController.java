...
public class MembersManagementController {
    ...
    public void btnAddOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
       ...
       boolean isAdd= memberDAO.save(memberDTO);
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        MemberDTO memberDTO=new MemberDTO(memberId,memberName,memberAddress,memberContact,memberRegistorDate);
        boolean IsUpdate= memberDAO.update(memberId,memberName,memberDTO);
        if (IsUpdate){
    ...
    public void btnDeleteOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        memberId=txtMemberId.getText();
        memberName=txtmemberName.getText();
        boolean IsDelete= memberDAO.delete(memberId,memberName);
        if (IsDelete){
    ...
    public void btnSearchOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
       try {
           memberId = txtMemberId.getText();
           MemberDTO memberDTO = memberDAO.search(memberId);
    ...
    public void setValuesToTable() throws SQLException, ClassNotFoundException {
        List<MemberDTO> AddMemberDetails=memberDAO.GetDetails();

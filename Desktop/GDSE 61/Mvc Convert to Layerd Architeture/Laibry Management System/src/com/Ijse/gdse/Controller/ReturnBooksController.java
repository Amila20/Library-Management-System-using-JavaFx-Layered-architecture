...
import com.Ijse.gdse.Dao.Custom.Impl.ReturnDAOImpl;
...
public class ReturnBooksController {
    ...
    ReturnDAOImpl returnDAO= (ReturnDAOImpl) DAOFactory.getDaoFactory().getDaoTypes(DAOFactory.DAOTypes.RETURN);
    ...
    private void loadAllBookIds() throws SQLException, ClassNotFoundException {
        ObservableList<String> observableList= FXCollections.observableArrayList(booksDAO.getIssuesBookIds());
        cmbBookID.setItems(observableList);
    }
    private void  loadAllMembersIds() throws SQLException, ClassNotFoundException {
        ObservableList<String> observableList=FXCollections.observableArrayList(memberDAO.getIssuesMembersId());
    ...
    private void loadNextOrderId() {
        try {
            String orderId =returnDAO.getNextOrderId();
    ...
    public void btnReturnOnACtion(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        try {
            boolean saveIssueBooks = returnDAO.saveReturnBook(returnDTO);
            if (saveIssueBooks){
                boolean saveIssueBookDetails=returnDAO.SaveReturnBookDetails(returnBookDetails);
                returnDAO.SaveAvailableBookDetails(AvailableBookDetails);
